            ...
            <div className="container-xs">
              <Slide direction="down" cascade delay={400} damping={0.2}>
                <p className="m-0 mb-32">
                  create a{" "}
                  <span className="text-color-primary">futureDiam</span> ousSed
                  eirmod et erat dolores voluptua dolores.{" "}
                  <span className="text-color-primary">futureDiam.</span>{" "}
                  forAliquyam ipsum.{" "}
                  <span className="text-color-primary">futureDiam</span> Erat
                  sed eos diam.
                </p>
                <div>
